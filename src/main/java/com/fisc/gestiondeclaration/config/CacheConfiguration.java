package com.fisc.gestiondeclaration.config;
...
public class CacheConfiguration implements DisposableBean {
    ...
    public HazelcastInstance hazelcastInstance(JHipsterProperties jHipsterProperties) {
        ...
        HazelcastInstance hazelCastInstance = Hazelcast.getHazelcastInstanceByName("gestiondeclaration");
        if (hazelCastInstance != null) {
            log.debug("Hazelcast already initialized");
            return hazelCastInstance;
        }
        Config config = new Config();
        config.setInstanceName("gestiondeclaration");
        ...
        config.getMapConfigs().put("com.fisc.gestiondeclaration.domain.*", initializeDomainMapConfig(jHipsterProperties));
