...
import com.fisc.gestiondeclaration.GestiondeclarationApp;
...
@SpringBootTest(classes = GestiondeclarationApp.class)
@DirtiesContext(classMode = DirtiesContext.ClassMode.BEFORE_CLASS)
public class GestiondeclarationKafkaResourceIT {
    ...
    @Autowired
    private GestiondeclarationKafkaProducer producer;

    @Autowired
    private GestiondeclarationKafkaConsumer consumer;
    ...
    @BeforeEach
    public void setup() {
        GestiondeclarationKafkaResource kafkaResource = new GestiondeclarationKafkaResource(producer);
    ...
    public void producedMessageHasBeenConsumed() throws Exception {
        restMockMvc.perform(post("/api/gestiondeclaration-kafka/publish?message=test"))
